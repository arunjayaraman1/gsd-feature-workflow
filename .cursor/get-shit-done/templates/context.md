...
- **Backend:** [API/service behavior for this phase]
- **Database:** [Schema/table/persistence behavior for this phase]
- **UI:** [Component/screen behavior for this phase]
- **Integration:** [How UI connects to API/services]
- **E2E Validation:** [How usability is validated end-to-end]

### Extension Strategy (if this is an extension phase)
- **Base pipeline reused:** [Existing route/table/handler/service to extend]
- **Pluggable component:** [stub | retrieval+LLM | refusal layer | other]
- **No-duplication check:** [How duplicate systems are avoided]
...
- "Reuse existing chat handler and swap stub generator for retrieval+LLM plugin"
