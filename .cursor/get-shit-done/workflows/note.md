...
- **Global scope**: `/Users/newpage/Desktop/demo/get-shit-done/.cursor/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/newpage/Desktop/demo/get-shit-done/.cursor/notes/`)
...
2. Glob `/Users/newpage/Desktop/demo/get-shit-done/.cursor/notes/*.md` (if directory exists) — global notes
...
Global (/Users/newpage/Desktop/demo/get-shit-done/.cursor/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/newpage/Desktop/demo/get-shit-done/.cursor/notes/` — works in any directory
