...
Commit:
```bash
node "/Users/newpage/Desktop/demo/get-shit-done/.cursor/get-shit-done/bin/gsd-tools.cjs" commit "docs: cross-AI review for phase {N}" --files {phase_dir}/{padded_phase}-REVIEWS.md
```
</step>
