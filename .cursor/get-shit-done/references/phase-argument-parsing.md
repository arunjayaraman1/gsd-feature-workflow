...
```bash
PHASE_INFO=$(node "/Users/newpage/Desktop/demo/get-shit-done/.cursor/get-shit-done/bin/gsd-tools.cjs" find-phase "${PHASE}")
```
...
```bash
PHASE_CHECK=$(node "/Users/newpage/Desktop/demo/get-shit-done/.cursor/get-shit-done/bin/gsd-tools.cjs" roadmap get-phase "${PHASE}" --pick found)
...
```bash
PHASE_DIR=$(node "/Users/newpage/Desktop/demo/get-shit-done/.cursor/get-shit-done/bin/gsd-tools.cjs" find-phase "${PHASE}" --raw)
```
